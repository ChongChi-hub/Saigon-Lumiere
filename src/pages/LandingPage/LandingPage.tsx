        ...
        <div className="flex flex-col">
            <section className="bg-background-light px-6 py-6 min-h-[calc(100vh-80px)] flex flex-col justify-center w-full max-w-[1200px] mx-auto">
                <div className="relative overflow-hidden rounded-xl bg-slate-100 border border-slate-200 h-full min-h-[500px] flex flex-col items-center justify-center p-8 text-center group/hero transition-all flex-1">
                    ...
                    <div className="relative z-30 mb-10 mt-8 group cursor-default">
                    ...
                    <div className="flex flex-col gap-4 relative z-10 drop-shadow-md">
            ...
            <section id="trai-nghiem" className="scroll-mt-20 min-h-[calc(100vh-80px)] px-6 py-10 flex flex-col justify-center w-full max-w-300 mx-auto">
                <div className="mb-6 flex items-end justify-between border-b border-slate-200 pb-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-slate-900 font-display">Trải Nghiệm Tinh Hoa</h2>
                    <span className="text-xs uppercase tracking-widest text-slate-400">Khám Phá</span>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="group flex flex-col bg-white rounded-lg overflow-hidden border border-slate-200 hover:shadow-xl transition-all hover:-translate-y-1">
